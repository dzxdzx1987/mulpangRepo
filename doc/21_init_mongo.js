	...
	var members = [
		{
			...
			password: "uzoolove", 
			profileImage: "uzoolove@gmail.com.jpg",
			regDate: now,
			auth:1
		},
		{
			...
			password: "seulbinim", 
			profileImage: "seulbinim@gmail.com.jpg",
			regDate: now,
			auth:1
		},
		{
...
function registCoupon(){
	...
	db.shop.find().toArray(function(err, shops){
		...
		var coupons = [
       {
          ...
          price: 4700, 
          quantity: 100, 
          saleDate: {start: new Date(now*1-1000*60*60*24), finish: new Date(now*1+1000*60*60*24*5)}, 
          useDate: {start: new Date(now*1-1000*60*60*24*2), finish: new Date(now*1+1000*60*60*24*60)}, 
          ...
          satisfactionAvg: 3.678454
       },
   		{
   			...
   			price: 12000, 
   			quantity: 200, 
   			saleDate: {start: new Date(now*1-1000*60*60*24), finish: new Date(now*1+1000*60*60*24*20)}, 
...
function registEpilogue(){
	...
	var epilogues = [
		{
			...
			regDate: new Date(now-1000*60*60*24*1)			
		},
		{
			_id: epilogueId[1],
			couponId: couponObjId[0],
			...
			regDate: new Date(now-1000*60*60*24*5)
		},
		{
			_id: epilogueId[2],
			...
			satisfaction: 5,
			content: "와플 짱!!! 강추해요.",
			regDate: new Date(now-1000*60*60*24*8)			
		},
		{
			_id: epilogueId[3],
			couponId: couponObjId[1],
			...
			regDate: new Date(now-1000*60*60*24*20)			
		},
		{
			_id: epilogueId[4],
			...
			satisfaction: 5,
			content: "소지섭 봤어요.",
			regDate: new Date(now-1000*60*60*24*4)			
		},
		{
			_id: epilogueId[5],
			couponId: couponObjId[15],
			...
			regDate: new Date(now-1000*60*60*24*3)
		},
		{
			_id: epilogueId[6],
			couponId: couponObjId[15],
	...
	db.epilogue.insert(epilogues, registPurchase);
	...
	var purchases = [
		{
			...
			regDate: new Date(now-1000*60*60*24*2+1000*50008)
		},
		{
			couponId: couponObjId[1], 
			email: "uzoolove@gmail.com", 
			...
			regDate: new Date(now-1000*60*60*24*7+1000*35001)
		},
		{
			couponId: couponObjId[1], 
			email: "test", 
			...
			regDate: new Date(now-1000*60*60*24*3+1000*67002)	
		},
		{
			...
			regDate: new Date(now-1000*60*60*24*10+1000*58003)	
		},
		{
			couponId: couponObjId[2], 
			...
			regDate: new Date(now-1000*60*60*24*10+1000*38009)	
		},
		{
			couponId: couponObjId[2], 
			...
			regDate: new Date(now-1000*60*60*24*3+1000*12006)	
		},
		{
			couponId: couponObjId[15], 
			email: "seulbinim@gmail.com", 
			...
			regDate: new Date(now-1000*60*60*24*4+1000*77054)	
		},
		{
			couponId: couponObjId[15], 
			email: "test", 
			...
			regDate: new Date(now-1000*60*60*24*3+1000*72009)	
		},
		{
			couponId: couponObjId[15], 
			email: "uzoolove@gmail.com", 
			...
			epilogueId: epilogueId[6],
 			regDate: new Date(now-1000*60*60*24*4+1000*78103)	
		}
	];
	
	// 6. 구매 데이터 등록 완료 시 등록한 쿠폰 목록을 확인한다.
	db.purchase.insert(purchases, findCoupon);
